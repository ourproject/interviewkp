...
class ClipsControllerTest < ActionController::TestCase
  ...
  test "should create clip" do
    assert_difference('Clip.count') do
      post :create, clip: { interview_id: @clip.interview_id, question_id: @clip.question_id, url: @clip.url, user_id: @clip.user_id }
    end
  ...
  test "should update clip" do
    patch :update, id: @clip, clip: { interview_id: @clip.interview_id, question_id: @clip.question_id, url: @clip.url, user_id: @clip.user_id }
    assert_redirected_to clip_path(assigns(:clip))
  end
